    ...
    submitBtn.addEventListener('click', async (e) => {
        ...
        try {
            ...
            const formData = {
                ...
                status: document.getElementById('status').value, // Add this back to satisfy NOT NULL
                ...
                tracking_number: document.getElementById('trackingNumber') ? document.getElementById('trackingNumber').value || null : null,
                courier_phone: null // Manual entry doesn't have this field yet
            };
